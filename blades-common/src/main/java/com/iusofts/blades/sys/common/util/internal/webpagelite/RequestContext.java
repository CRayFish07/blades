...
public abstract class RequestContext {
    ...
    public final PrintWriter getWriter() {
        return Assert.assertNotNull(writer, Assert.ExceptionType.ILLEGAL_STATE, "call getWriter(contentType) first");
    }
    ...
    public final OutputStream getOutputStream() {
        return Assert.assertNotNull(stream, Assert.ExceptionType.ILLEGAL_STATE, "call getOutputStream(contentType) first");
    }
