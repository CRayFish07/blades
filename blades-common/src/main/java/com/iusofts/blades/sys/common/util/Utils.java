...
import com.iusofts.blades.sys.common.util.i18n.LocaleUtil;
import com.iusofts.blades.sys.common.util.internal.StaticFunctionDelegatorBuilder;
...
public class Utils {
    ...
    private static final Map<String, Object> ALL_UTILS = Collections.unmodifiableMap(ArrayUtil.arrayToMap(new Object[][] { //
