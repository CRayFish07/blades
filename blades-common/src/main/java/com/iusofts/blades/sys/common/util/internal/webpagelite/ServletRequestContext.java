...
import static com.iusofts.blades.sys.common.util.ServletUtil.*;
...
public class ServletRequestContext extends RequestContext {
    ...
    public ServletRequestContext(HttpServletRequest request, HttpServletResponse response, ServletContext servletContext) {
        ...
        this.request = Assert.assertNotNull(request, "request is null");
        this.response = Assert.assertNotNull(response, "response is null");
        this.servletContext = Assert.assertNotNull(servletContext, "servletContext is null");
    }
