...
import static com.iusofts.blades.sys.common.util.internal.Entities.*;
...
import com.iusofts.blades.sys.common.util.internal.Entities;
...
public class ExceptionUtil {
    ...
    public static String getStackTraceForHtmlComment(Throwable throwable) {
        return StringEscapeUtil.escapeEntities(HTML40_COMMENT, getStackTrace(throwable));
    }
}
