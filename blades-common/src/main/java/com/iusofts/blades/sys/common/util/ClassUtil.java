...
public class ClassUtil {
    ...
    public static String getSimpleMethodSignature(Method method, boolean withModifiers, boolean withReturnType,
        ...
        if (withExceptionType) {
            ...
            if (!ArrayUtil.isEmptyArray(exceptionTypes)) {
                buf.append(" throws ");
    ...
    public static String locateClass(String className, ClassLoader loader) {
        className = Assert.assertNotNull(trimToNull(className), "className");
        ...
        if (locationURL != null) {
            ...
            location = location.replaceAll("^(jar|zip):|!/$", BasicConstant.EMPTY_STRING);
        }
