...
public class Servlet3Util {
    ...
    static {
        List<MethodInfo> methodList = CollectionUtil.createLinkedList();
        int count = 0;
    ...
    public static void request_registerAsyncListener(HttpServletRequest request, MyAsyncListener listenerImpl) {
        ...
        Object listener = Assert.assertNotNull(asyncListenerBuilder, "asyncListenerBuilder").toObject(listenerImpl); // builder should not be null
