...
import static com.iusofts.blades.sys.common.util.ClassUtil.*;
...
import com.iusofts.blades.sys.common.util.BasicConstant;
...
public class StaticFunctionDelegatorBuilder extends DynamicClassBuilder {
        ...
        if (mixinInterface == null) {
            ...
            im.setNamingPolicy(new DefaultNamingPolicy() {
                ...
                public String getClassName(String prefix, String source, Object key, Predicate names) {
                    return super.getClassName(BasicConstant.EMPTY_STRING, getSimpleClassName(StaticFunctionDelegatorBuilder.class),
                                              key, names);
                }
            });
    ...
    private Map<Method, FastMethod> getMethodMappings(Class<?> intfs) {
        ...
        Map<Method, FastMethod> methodMappings = CollectionUtil.createHashMap();
