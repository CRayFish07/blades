...
import com.iusofts.blades.sys.common.util.ClassInstantiationException;
...
public abstract class CharConverter {
    ...
    // 私有变量
    private static final Map<String, CharConverter> converters = CollectionUtil.createConcurrentHashMap();
