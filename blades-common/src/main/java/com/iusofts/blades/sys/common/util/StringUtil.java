...
public class StringUtil {
    ...
    public static String[] split(String str, char separatorChar) {
        ...
        List<String> list = CollectionUtil.createLinkedList();
        int i = 0;
        int start = 0;
        boolean match = false;
    ...
    public static String join(Object[] array, String separator) {
        ...
        if (separator == null) {
            separator = BasicConstant.EMPTY_STRING;
        }
    ...
    public static String overlay(String str, String overlay, int start, int end) {
        ...
        if (overlay == null) {
            overlay = BasicConstant.EMPTY_STRING;
        }
    ...
    public static void indent(StringBuilder buf, String str, String indent) {
        ...
        indent = ObjectUtil.defaultIfNull(indent, BasicConstant.EMPTY_STRING);
	 ...
	 * @return
	 */
	public static String allInOne(String all,char one){
