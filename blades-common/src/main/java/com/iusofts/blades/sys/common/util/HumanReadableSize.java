...
public class HumanReadableSize {
    ...
    private final static Map<String, Long> UNIT_NAMES = CollectionUtil.createHashMap();
    ...
    private static long parse(String humanReadbleSize, String... nas) {
        humanReadbleSize = Assert.assertNotNull(StringUtil.trimToNull(humanReadbleSize), "human readble size");
