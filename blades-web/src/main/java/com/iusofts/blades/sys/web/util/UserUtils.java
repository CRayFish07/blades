...
public class UserUtils {
	...
	private static UserService userDao = (UserService) ServiceLocator.init().getService(UserService.class);
	private static AccountService accountDao = (AccountService) ServiceLocator.init().getService(AccountService.class);
	private static RoleService roleDao = (RoleService) ServiceLocator.init().getService(RoleService.class);
	private static ResourceService resourceDao = (ResourceService) ServiceLocator.init().getService(ResourceService.class);
	...
	public static User get(String id){
		...
		if (user ==  null){
			...
			user.setRoleList(roleDao.getList(new Role()));
	...
	public static List<Role> getRoleList(){
		...
		if (roleList == null){
			User user = getUser();
			roleList=roleDao.getList(new Role());
	...
	public static List<Resource> getResourceList(){
		...
		if (resourceList == null){
			User user = getUser();
			resourceList=resourceDao.getList(new Resource());
