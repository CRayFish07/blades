...
import com.iusofts.blades.sys.common.util.ObjectUtils;
...
public class JedisUtils {
	...
	private static JedisPool jedisPool = (JedisPool) ServiceLocator.init().getService(JedisPool.class);
		...
		try {
			...
			if (jedis.exists(getBytesKey(key))) {
				...
				for (Map.Entry<byte[], byte[]> e : map.entrySet()){
					value.put(StringUtil.bytesToString(e.getKey()), toObject(e.getValue()));
				}
