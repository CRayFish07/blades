...
import static com.iusofts.blades.sys.common.util.Assert.assertTrue;
import static com.iusofts.blades.sys.common.util.CollectionUtil.createHashSet;
import static com.iusofts.blades.sys.common.util.CollectionUtil.createTreeSet;
...
import com.iusofts.blades.sys.common.util.internal.Servlet3Util.Servlet3OutputStream;
...
public abstract class FilterBean implements Filter {
    ...
    private static class FilterConfigPropertyValues extends MutablePropertyValues {
        ...
        public FilterConfigPropertyValues(FilterConfig config, Set<String> requiredProperties) throws ServletException {
            Set<String> missingProps = CollectionUtil.createTreeSet(requiredProperties);
