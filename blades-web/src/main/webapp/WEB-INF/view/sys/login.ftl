...
<script src="${ctx}/resource/sys/js/cloud.js" type="text/javascript"></script>
...
<body style="background-color:#1c77ac; background-image:url(${ctx}/resource/sys/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
...
<div class="logintop">    
    ...
    <div class="loginbm">版权所有  2016 iusofts.com</div>
