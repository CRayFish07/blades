...
<script type="text/javascript">
	...
	$(document).ready(function(e) {
		...
		new Validation().init({
			...
			success:function(){
				layer.msg("添加成功！");
					window.location.href="${ctx }/sys/role/list/${sort}.do";
			},
...
<body>
	...
	<div class="formbody">
		...
		<form id="myForm" method="post" action="${ctx }/sys/role/save.do">
			<ul class="forminfo">
				<li><label>角色名称<b>*</b></label><input name="name" type="text" class="dfinput" /><i id="msg_name">名称不能超过30个字符</i></li>
				<li><label>角色别称</label><input name="alias" type="text" class="dfinput" /><i id="msg_alias">昵称</i></li>
				<li><label>角色代码<b>*</b></label><input name="code" type="text" class="dfinput" /><i id="msg_code">角色代码是唯一的</i></li>
				<li><label>排序号码</label><input name="orderNo" type="text" class="dfinput" /><i id="msg_orderNo">排序号码</i></li>
				<li><label>描述</label><input name="description" type="text" class="dfinput" /><i id="msg_description">角色描述</i></li>
