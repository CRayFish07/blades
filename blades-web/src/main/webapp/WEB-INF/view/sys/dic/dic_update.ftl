...
<body>
    ...
    <div class="formtitle"><span>『${dic.name }』信息编辑</span></div>
    <form id="myForm" method="post" action="update.do?id=${dic.id }">
    <ul class="forminfo">
    <li><label>字典名称<b>*</b></label><input name="name" type="text" class="dfinput" value="${dic.name }" /><i id="msg_name">名称不能超过30个字符</i></li>
    <li><label>字典别称</label><input name="alias" type="text" class="dfinput" value="${dic.alias }" /><i id="msg_alias"></i></li>
    <li><label>字典代码<b>*</b></label><input name="code" type="text" class="dfinput" value="${dic.code }" /><i id="msg_code">字典代码是唯一的</i></li>
    <li><label>外部代码</label><input name="fcode" type="text" class="dfinput" value="${dic.fcode }" /><i id="msg_fcode">外部代码（默认值=代码）</i></li>
    <li><label>采用标准<b>*</b></label>  
	    <div class="vocation">
		    <select class="select1" name="standard">
			    <option value="01">国标GB</option>
			    <option value="02">部标GA</option>
			    <option value="03">省厅标准SB</option>
			    <option value="04">自定义标准ZB</option>
		    </select>
	    </div>
    </li>
    <li><label>字典分类<b>*</b></label>  
	    <div class="vocation">
		    <select class="select1" name="classify">
				<@dict.getOptions type="DIC_TYPE" value=dic.classify />
		    </select>
	    </div>
    </li>
    ...
    <li><label>排序号码</label><input name="orderNo" type="text" class="dfinput" value="${dic.orderNo }" style="width: 150px;"/></li>
    <li><label>图标</label><input name="icon" type="text" class="dfinput" value="${dic.icon }"/><i>图标路径</i></li>
    <li><label>字典描述</label><textarea name="description" cols="" rows="" class="textinput">${dic.description }</textarea></li>
