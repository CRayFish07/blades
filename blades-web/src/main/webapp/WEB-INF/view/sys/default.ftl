...
<script type="text/javascript" src="${ctx}/resource/sys/js/jsapi.js"></script>
<script type="text/javascript" src="${ctx}/resource/sys/js/format+zh_CN,default,corechart.I.js"></script>		
<script type="text/javascript" src="${ctx}/resource/sys/js/jquery.gvChart-1.0.1.min.js"></script>
<script type="text/javascript" src="${ctx}/resource/sys/js/jquery.ba-resize.min.js"></script>
...
<body>
    ...
    <ul class="tooli">
    <li><span><img src="${ctx}/resource/sys/images/d01.png" /></span><p><a href="#">信息资料</a></p></li>
    <li><span><img src="${ctx}/resource/sys/images/d02.png" /></span><p><a href="#">编辑</a></p></li>
    <li><span><img src="${ctx}/resource/sys/images/d03.png" /></span><p><a href="#">记事本</a></p></li>
    <li><span><img src="${ctx}/resource/sys/images/d04.png" /></span><p><a href="#">任务日历</a></p></li>
    <li><span><img src="${ctx}/resource/sys/images/d05.png" /></span><p><a href="#">图片管理</a></p></li>
    <li><span><img src="${ctx}/resource/sys/images/d06.png" /></span><p><a href="#">交易</a></p></li>
    <li><span><img src="${ctx}/resource/sys/images/d07.png" /></span><p><a href="#">档案袋</a></p></li>    
    </ul>
